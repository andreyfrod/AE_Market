<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="listaProductosElectronicos.aspx.cs" Inherits="AE_Market_Web.listaProductosElectronicos" %>
...
<%--            <div class="col-sm-10">
         ...
         <asp:ListView ID="listaProductoElectronico" runat="server" GroupItemCount="3"
        DataKeyNames="idProducto"
        ItemType="Entidades.ProductoEntidad"
        SelectMethod="listaProductoElectronico_GetData"
             >
        <EmptyDataTemplate>
            <div class="col-lg-4">
                No hay datos
