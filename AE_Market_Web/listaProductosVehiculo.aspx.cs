...
{
    public partial class listaProductosVehiculo : System.Web.UI.Page
    {
        ...
        public List<Entidades.ProductoEntidad> listaProductoVehiculo_GetData()
        {
            return ProductoLN.ObtenerTipo("Vehiculo");
        }
    }
}