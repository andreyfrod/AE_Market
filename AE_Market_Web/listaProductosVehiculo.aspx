<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="listaProductosVehiculo.aspx.cs" Inherits="AE_Market_Web.listaProductosVehiculo" %>
...
<%--            <div class="col-sm-10">
         ...
         <asp:ListView ID="listaProductoVehiculo" runat="server" GroupItemCount="3"
        DataKeyNames="idProducto"
        ItemType="Entidades.ProductoEntidad"
        SelectMethod="listaProductoVehiculo_GetData"
             >
        <EmptyDataTemplate>
            <div class="col-lg-4">
                No hay datos
